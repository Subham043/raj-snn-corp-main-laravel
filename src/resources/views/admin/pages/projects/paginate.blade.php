...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @include('admin.includes.breadcrumb', ['page'=>'Projects', 'page_link'=>route('project_list.get'), 'list'=>['List']])
        <!-- end page title -->
                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="{{route('project_create.get')}}" style="background:green;border-color:green;" type="button" class="btn btn-success add-btn" id="create-btn"><i class="ri-add-line align-bottom me-1"></i> Create</a>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    @include('admin.includes.search_list', ['link'=>route('project_list.get')])
                                </div>
                            </div>
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="customer_name">Project Slug</th>
                                            <th class="sort" data-sort="status">Project Status</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <div class="edit">
                                                        <a href="{{route('project_table_list.get', $item->id)}}" class="btn btn-sm btn-info edit-item-btn">Table Section</a>
                                                    </div>
                                                    <div class="edit">
                                                        <a href="{{route('project_gallery_list.get', $item->id)}}" class="btn btn-sm btn-info edit-item-btn">Gallery Section</a>
                                                    </div>
                                                    <div class="edit">
                                                        <a href="{{route('project_specification_list.get', $item->id)}}" class="btn btn-sm btn-info edit-item-btn">Specification Section</a>
                                                    </div>
                                                    <div class="edit">
                                                        <a href="{{route('project_plan_category_list.get', $item->id)}}" class="btn btn-sm btn-info edit-item-btn">Plan Category Section</a>
                                                    </div>
                                                    <div class="edit">
