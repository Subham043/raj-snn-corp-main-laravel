                            ...
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        ...
                                        <a href="{{route('project_gallery_create.get', $project_id)}}" style="background:green;border-color:green;" type="button" class="btn btn-success add-btn" id="create-btn"><i class="ri-add-line align-bottom me-1"></i> Create</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody class="list form-check-all" id="image-container">
                                        ...
                                        <tr>
                                            <td class="customer_name">
                                                <img src="{{$item->image_link}}" alt="" style="height:80px; object-fit:contain;">
                                            </td>
                                            <td class="date">{{$item->created_at}}</td>
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn" style="background:red" onclick="deleteHandler('{{route('project_gallery_delete.get', [$project_id, $item->id])}}')">Delete</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
