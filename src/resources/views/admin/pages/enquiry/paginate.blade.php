...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @include('admin.includes.breadcrumb', ['page'=>'Enquiry', 'page_link'=>route('enquiry_list.get'), 'list'=>['List']])
        <!-- end page title -->
                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <a href="{{route('enquiry_excel.get')}}" download type="button" class="btn btn-info add-btn" id="create-btn"><i class="ri-file-excel-fill align-bottom me-1"></i> Excel</a>
                                </div>
                                <div class="col-sm">
